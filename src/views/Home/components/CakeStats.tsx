...
const CakeStats = () => {
  ...
  let ricePerBlock = 0;
  if(farms && farms[0] && farms[0].ricePerBlock){
    ricePerBlock = new BigNumber(farms[0].ricePerBlock).div(new BigNumber(10).pow(18)).toNumber();
  }
    ...
    <StyledCakeStats>
      <CardBody>
        ...
        <Row>
          ...
          <Text bold fontSize="14px">{ricePerBlock}</Text>
        </Row>
      </CardBody>
    </StyledCakeStats>
  )
